...
function Schedule(props) {
    ...
    const getSchedule = async () => {
        await userApi.getScheduleDoctor(accessToken).then(res => {
            const sche = res
    ...
    const handleClickToTimeServing = () => {
        navigate('/doctor/lich-hen/lich-lam-viec')
    }

    return (
        <Box>
            <Button variant='contained' onClick={handleClickToTimeServing}>Lịch làm việc</Button>
            <Box sx={{ width: '100%' }}>
